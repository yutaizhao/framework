...
#ifndef ARCANE_CASEOPTION_AXLSTAR_HDF5READERWRITER_H
#define ARCANE_CASEOPTION_AXLSTAR_HDF5READERWRITER_H
...
public:
  ...
  CaseOptionsHdf5ReaderWriter(Arcane::ICaseOptions* co)
    : m_case_options(co)
      , filesetSize(Arcane::CaseOptionBuildInfo(_configList(),
        ...
        /* max-occurs */ 1,
        /* optional   */ false))
      , indexModulo(Arcane::CaseOptionBuildInfo(_configList(),
        /* name       */ "index-modulo", _element(),
        /* default    */ "0",
        /* min-occurs */ 1,
        /* max-occurs */ 1,
        /* optional   */ false))
...
indexModulo.addAlternativeNodeName(
          /* language         */ Arcane::String("fr"),
          /* alternative name */ Arcane::String("index-modulo"));
addAlternativeNodeName(
          /* language         */ Arcane::String("fr"),
          /* alternative name */ Arcane::String("arcane-hdf5-checkpoint2"));
  }
...
public:
  // Interfaces for main CaseOptions
    ...
    Arcane::Integer getIndexModulo() { return indexModulo(); }
...
public:
  ...
  Arcane::CaseOptionInteger    indexModulo;
};
...
#ifndef ARCANE_MODULE_AXLSTAR_HDF5READERWRITER_H
#define ARCANE_MODULE_AXLSTAR_HDF5READERWRITER_H
...
public:
  ...
  {
    si->setCaseOptionsFileName("Hdf5ReaderWriter_arcane_hdf5");
    si->setAxlVersion(0.0);
    si->setDefaultTagName("hdf5-reader-writer");
    si->setAxlContent(getAxlContent());
    si->setTagName("arcane-hdf5-checkpoint2","fr");
...
public:
    ...
    , m_options(nullptr)
  {
    ...
    if (co) {
      m_options = new CaseOptionsHdf5ReaderWriter(co);
    }
...
public:
  ...
  CaseOptionsHdf5ReaderWriter* options() const { return m_options; }
...
#define ARCANE_REGISTER_SERVICE_HDF5READERWRITER(service_name,class_name) \
