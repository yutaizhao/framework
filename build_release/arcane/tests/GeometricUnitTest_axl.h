...
#ifndef ARCANE_CASEOPTION_AXLSTAR_ARCANETEST_GEOMETRICUNITTEST_H
#define ARCANE_CASEOPTION_AXLSTAR_ARCANETEST_GEOMETRICUNITTEST_H
...
//! Options
class CaseOptionsGeometricUnitTest
{
public:
  ...
  CaseOptionsGeometricUnitTest(Arcane::ICaseOptions* co)
    : m_case_options(co)
  {
...
#ifndef ARCANE_MODULE_AXLSTAR_ARCANETEST_GEOMETRICUNITTEST_H
#define ARCANE_MODULE_AXLSTAR_ARCANETEST_GEOMETRICUNITTEST_H
...
class ArcaneGeometricUnitTestObject
...
public:
  ...
  {
    si->setCaseOptionsFileName("GeometricUnitTest_arcane_tests");
    si->setAxlVersion(1.0);
    si->setDefaultTagName("geometric-unit-test");
...
public:
  ...
  //! Constructeur
  ArcaneGeometricUnitTestObject(const Arcane::ServiceBuildInfo& sbi)
    : Arcane::BasicUnitTest(sbi)
    , m_options(nullptr)
  {
    Arcane::ICaseOptions* co = sbi.caseOptions();
    if (co) {
      m_options = new CaseOptionsGeometricUnitTest(co);
    }
	
  }

  //! Destructeur
  virtual ~ArcaneGeometricUnitTestObject()
  {
    delete m_options;
  }
...
public:
  ...
  CaseOptionsGeometricUnitTest* options() const { return m_options; }
 
private:
        
  //! Options du jeu de données du service
  CaseOptionsGeometricUnitTest* m_options;
...
#define ARCANE_REGISTER_SERVICE_GEOMETRICUNITTEST(service_name,class_name) \
