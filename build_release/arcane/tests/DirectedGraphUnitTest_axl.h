...
#ifndef ARCANE_CASEOPTION_AXLSTAR_ARCANETEST_DIRECTEDGRAPHUNITTEST_H
#define ARCANE_CASEOPTION_AXLSTAR_ARCANETEST_DIRECTEDGRAPHUNITTEST_H
...
//! Options
class CaseOptionsDirectedGraphUnitTest
{
public:
  ...
  CaseOptionsDirectedGraphUnitTest(Arcane::ICaseOptions* co)
    : m_case_options(co)
  {
...
#ifndef ARCANE_MODULE_AXLSTAR_ARCANETEST_DIRECTEDGRAPHUNITTEST_H
#define ARCANE_MODULE_AXLSTAR_ARCANETEST_DIRECTEDGRAPHUNITTEST_H
...
class ArcaneDirectedGraphUnitTestObject
...
public:
  ...
  {
    si->setCaseOptionsFileName("DirectedGraphUnitTest_arcane_tests");
    si->setAxlVersion(1.0);
    si->setDefaultTagName("directed-graph-unit-test");
...
public:
  ...
  //! Constructeur
  ArcaneDirectedGraphUnitTestObject(const Arcane::ServiceBuildInfo& sbi)
    : Arcane::BasicUnitTest(sbi)
    , m_options(nullptr)
  {
    Arcane::ICaseOptions* co = sbi.caseOptions();
    if (co) {
      m_options = new CaseOptionsDirectedGraphUnitTest(co);
    }
	
  }

  //! Destructeur
  virtual ~ArcaneDirectedGraphUnitTestObject()
  {
    delete m_options;
  }
...
public:
  ...
  CaseOptionsDirectedGraphUnitTest* options() const { return m_options; }
 
private:
        
  //! Options du jeu de données du service
  CaseOptionsDirectedGraphUnitTest* m_options;
...
#define ARCANE_REGISTER_SERVICE_DIRECTEDGRAPHUNITTEST(service_name,class_name) \
