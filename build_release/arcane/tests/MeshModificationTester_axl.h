...
#ifndef ARCANE_CASEOPTION_AXLSTAR_ARCANETEST_MESHMODIFICATIONTESTER_H
#define ARCANE_CASEOPTION_AXLSTAR_ARCANETEST_MESHMODIFICATIONTESTER_H
...
//! Options
class CaseOptionsMeshModificationTester
{
public:
  ...
  CaseOptionsMeshModificationTester(Arcane::ICaseOptions* co)
    : m_case_options(co)
  {
...
#ifndef ARCANE_MODULE_AXLSTAR_ARCANETEST_MESHMODIFICATIONTESTER_H
#define ARCANE_MODULE_AXLSTAR_ARCANETEST_MESHMODIFICATIONTESTER_H
...
class ArcaneMeshModificationTesterObject
...
public:
  ...
  {
    si->setCaseOptionsFileName("MeshModificationTester_arcane_tests");
    si->setAxlVersion(1.0);
    si->setDefaultTagName("mesh-modification-tester");
...
public:
  ...
  //! Constructeur
  ArcaneMeshModificationTesterObject(const Arcane::ServiceBuildInfo& sbi)
    : Arcane::BasicUnitTest(sbi)
    , m_options(nullptr)
  {
    Arcane::ICaseOptions* co = sbi.caseOptions();
    if (co) {
      m_options = new CaseOptionsMeshModificationTester(co);
    }
	
  }

  //! Destructeur
  virtual ~ArcaneMeshModificationTesterObject()
  {
    delete m_options;
  }
...
public:
  ...
  CaseOptionsMeshModificationTester* options() const { return m_options; }
 
private:
        
  //! Options du jeu de données du service
  CaseOptionsMeshModificationTester* m_options;
...
#define ARCANE_REGISTER_SERVICE_MESHMODIFICATIONTESTER(service_name,class_name) \
