...
#ifndef ARCANE_CASEOPTION_AXLSTAR_ARCANETEST_CHECKPOINTTESTER_H
#define ARCANE_CASEOPTION_AXLSTAR_ARCANETEST_CHECKPOINTTESTER_H
...
//! Options
class CaseOptionsCheckpointTester
{
public:
  ...
  CaseOptionsCheckpointTester(Arcane::ICaseOptions* co)
    : m_case_options(co)
      , nbIteration(Arcane::CaseOptionBuildInfo(_configList(),
        ...
        /* max-occurs */ 1,
        /* optional   */ false))
      , backwardPeriod(Arcane::CaseOptionBuildInfo(_configList(),
        /* name       */ "backward-period", _element(),
        /* default    */ "1",
        /* min-occurs */ 1,
        /* max-occurs */ 1,
        /* optional   */ false))
...
public:
  // Interfaces for main CaseOptions
    ...
    Arcane::Integer getBackwardPeriod() { return backwardPeriod(); }
    Arcane::Integer getBackwardIteration() { return backwardIteration(); }
...
public:
  ...
  Arcane::CaseOptionInteger    backwardPeriod;
  Arcane::CaseOptionInteger    backwardIteration;
};
...
#ifndef ARCANE_MODULE_AXLSTAR_ARCANETEST_CHECKPOINTTESTER_H
#define ARCANE_MODULE_AXLSTAR_ARCANETEST_CHECKPOINTTESTER_H
...
class ArcaneCheckpointTesterObject
...
public:
  ...
  {
    si->setCaseOptionsFileName("CheckpointTester_arcane_tests");
    si->setAxlVersion(1.0);
    si->setDefaultTagName("checkpoint-tester");
...
public:
  ...
  //! Constructeur
  ArcaneCheckpointTesterObject(const Arcane::ServiceBuildInfo& sbi)
    : Arcane::BasicTimeLoopService(sbi)
    , m_options(nullptr)
  {
    Arcane::ICaseOptions* co = sbi.caseOptions();
    if (co) {
      m_options = new CaseOptionsCheckpointTester(co);
    }
	
  }

  //! Destructeur
  virtual ~ArcaneCheckpointTesterObject()
  {
    delete m_options;
  }
...
public:
  ...
  CaseOptionsCheckpointTester* options() const { return m_options; }
 
private:
        
  //! Options du jeu de données du service
  CaseOptionsCheckpointTester* m_options;
...
#define ARCANE_REGISTER_SERVICE_CHECKPOINTTESTER(service_name,class_name) \
