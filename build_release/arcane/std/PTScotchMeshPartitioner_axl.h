...
#ifndef ARCANE_CASEOPTION_AXLSTAR_PTSCOTCHMESHPARTITIONER_H
#define ARCANE_CASEOPTION_AXLSTAR_PTSCOTCHMESHPARTITIONER_H
  ...
  CaseOptionsPTScotchMeshPartitioner(Arcane::ICaseOptions* co)
    : m_case_options(co)
      , dumpGraph(Arcane::CaseOptionBuildInfo(_configList(),
        ...
        /* max-occurs */ 1,
        /* optional   */ false))
      , checkGraph(Arcane::CaseOptionBuildInfo(_configList(),
        /* name       */ "check-graph", _element(),
        /* default    */ "false",
        /* min-occurs */ 1,
        /* max-occurs */ 1,
        /* optional   */ false))
      , strategy(Arcane::CaseOptionBuildInfo(_configList(),
        /* name       */ "strategy", _element(),
        /* default    */ "",
        /* min-occurs */ 1,
        /* max-occurs */ 1,
        /* optional   */ false))
...
addAlternativeNodeName(
          ...
          /* alternative name */ Arcane::String("PTScotch"));
  }
...
public:
  // Interfaces for main CaseOptions
    ...
    bool getCheckGraph() { return checkGraph(); }
    Arcane::String getStrategy() { return strategy(); }
...
#ifndef ARCANE_MODULE_AXLSTAR_PTSCOTCHMESHPARTITIONER_H
#define ARCANE_MODULE_AXLSTAR_PTSCOTCHMESHPARTITIONER_H
...
public:
  ...
  {
    si->setCaseOptionsFileName("PTScotchMeshPartitioner_arcane_std");
    si->setAxlVersion(0.0);
    si->setDefaultTagName("p-t-scotch-mesh-partitioner");
    si->setAxlContent(getAxlContent());
    si->setTagName("PTScotch","fr");
...
public:
    ...
    , m_options(nullptr)
  {
    ...
    if (co) {
      m_options = new CaseOptionsPTScotchMeshPartitioner(co);
    }
...
public:
  ...
  CaseOptionsPTScotchMeshPartitioner* options() const { return m_options; }
...
#define ARCANE_REGISTER_SERVICE_PTSCOTCHMESHPARTITIONER(service_name,class_name) \
