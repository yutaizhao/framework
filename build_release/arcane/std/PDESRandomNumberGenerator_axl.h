...
#ifndef ARCANE_CASEOPTION_AXLSTAR_PDESRANDOMNUMBERGENERATOR_H
#define ARCANE_CASEOPTION_AXLSTAR_PDESRANDOMNUMBERGENERATOR_H
...
//! Options
class CaseOptionsPDESRandomNumberGenerator
{
public:
  ...
  CaseOptionsPDESRandomNumberGenerator(Arcane::ICaseOptions* co)
    : m_case_options(co)
      , initialSeed(Arcane::CaseOptionBuildInfo(_configList(),
        /* name       */ "initialSeed", _element(),
        /* default    */ "4294967297",
        /* min-occurs */ 1,
        /* max-occurs */ 1,
        /* optional   */ false))
...
public:
  // Interfaces for main CaseOptions
    ...
    Arcane::Int64 getInitialSeed() { return initialSeed(); }
...
public:
  ...
  Arcane::CaseOptionInt64    initialSeed;
};
...
#ifndef ARCANE_MODULE_AXLSTAR_PDESRANDOMNUMBERGENERATOR_H
#define ARCANE_MODULE_AXLSTAR_PDESRANDOMNUMBERGENERATOR_H
...
class ArcanePDESRandomNumberGeneratorObject
...
public:
  ...
  {
    si->setCaseOptionsFileName("PDESRandomNumberGenerator_arcane_std");
    si->setAxlVersion(1.0);
    si->setDefaultTagName("p-d-e-s-random-number-generator");
    si->setAxlContent(getAxlContent());
    Arcane::ServiceAllInterfaceRegisterer<ServiceClassType>::registerToServiceInfo(si
    ,ARCANE_SERVICE_INTERFACE(Arcane::IRandomNumberGenerator)
);
  }
...
public:
    ...
    , m_options(nullptr)
  {
    ...
    if (co) {
      m_options = new CaseOptionsPDESRandomNumberGenerator(co);
    }
...
public:
  ...
  CaseOptionsPDESRandomNumberGenerator* options() const { return m_options; }
 
private:
        
  //! Options du jeu de données du service
  CaseOptionsPDESRandomNumberGenerator* m_options;
...
#define ARCANE_REGISTER_SERVICE_PDESRANDOMNUMBERGENERATOR(service_name,class_name) \
