...
#ifndef ARCANE_CASEOPTION_AXLSTAR_VTKHDFPOSTPROCESSOR_H
#define ARCANE_CASEOPTION_AXLSTAR_VTKHDFPOSTPROCESSOR_H
...
public:
  ...
  CaseOptionsVtkHdfPostProcessor(Arcane::ICaseOptions* co)
    : m_case_options(co)
  {
...
#ifndef ARCANE_MODULE_AXLSTAR_VTKHDFPOSTPROCESSOR_H
#define ARCANE_MODULE_AXLSTAR_VTKHDFPOSTPROCESSOR_H
...
public:
  ...
  {
    si->setCaseOptionsFileName("VtkHdfPostProcessor_arcane_std");
    si->setAxlVersion(0.0);
    si->setDefaultTagName("vtk-hdf-post-processor");
...
public:
    ...
    , m_options(nullptr)
  {
    ...
    if (co) {
      m_options = new CaseOptionsVtkHdfPostProcessor(co);
    }
...
public:
  ...
  CaseOptionsVtkHdfPostProcessor* options() const { return m_options; }
...
#define ARCANE_REGISTER_SERVICE_VTKHDFPOSTPROCESSOR(service_name,class_name) \
