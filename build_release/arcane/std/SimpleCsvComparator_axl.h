...
#ifndef ARCANE_CASEOPTION_AXLSTAR_SIMPLECSVCOMPARATOR_H
#define ARCANE_CASEOPTION_AXLSTAR_SIMPLECSVCOMPARATOR_H
...
//! Options
class CaseOptionsSimpleCsvComparator
{
public:
  ...
  CaseOptionsSimpleCsvComparator(Arcane::ICaseOptions* co)
    : m_case_options(co)
  {
...
#ifndef ARCANE_MODULE_AXLSTAR_SIMPLECSVCOMPARATOR_H
#define ARCANE_MODULE_AXLSTAR_SIMPLECSVCOMPARATOR_H
...
class ArcaneSimpleCsvComparatorObject
  : public Arcane::BasicCaseOptionService
  , public Arcane::ISimpleTableComparator
{
public:
  ...
  {
    si->setCaseOptionsFileName("SimpleCsvComparator_arcane_std");
    si->setAxlVersion(1.0);
    si->setDefaultTagName("simple-csv-comparator");
    si->setAxlContent(getAxlContent());
    Arcane::ServiceAllInterfaceRegisterer<ServiceClassType>::registerToServiceInfo(si
    ,ARCANE_SERVICE_INTERFACE(Arcane::ISimpleTableComparator)
);
  }
...
public:
    ...
    , m_options(nullptr)
  {
    ...
    if (co) {
      m_options = new CaseOptionsSimpleCsvComparator(co);
    }
...
public:
  ...
  CaseOptionsSimpleCsvComparator* options() const { return m_options; }
...
#define ARCANE_REGISTER_SERVICE_SIMPLECSVCOMPARATOR(service_name,class_name) \
