...
#ifndef ARCANE_CASEOPTION_AXLSTAR_HONEYCOMB2DMESHGENERATOR_H
#define ARCANE_CASEOPTION_AXLSTAR_HONEYCOMB2DMESHGENERATOR_H
...
public:
  ...
  CaseOptionsHoneyComb2DMeshGenerator(Arcane::ICaseOptions* co)
    : m_case_options(co)
...
#ifndef ARCANE_MODULE_AXLSTAR_HONEYCOMB2DMESHGENERATOR_H
#define ARCANE_MODULE_AXLSTAR_HONEYCOMB2DMESHGENERATOR_H
...
public:
  ...
  {
    si->setCaseOptionsFileName("HoneyComb2DMeshGenerator_arcane_std");
    si->setAxlVersion(0.0);
    si->setDefaultTagName("honey-comb2-d-mesh-generator");
...
public:
    ...
    , m_options(nullptr)
  {
    ...
    if (co) {
      m_options = new CaseOptionsHoneyComb2DMeshGenerator(co);
    }
...
public:
  ...
  CaseOptionsHoneyComb2DMeshGenerator* options() const { return m_options; }
...
#define ARCANE_REGISTER_SERVICE_HONEYCOMB2DMESHGENERATOR(service_name,class_name) \
