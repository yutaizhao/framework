...
#ifndef ARCANE_CASEOPTION_AXLSTAR_SIMPLECSVOUTPUT_H
#define ARCANE_CASEOPTION_AXLSTAR_SIMPLECSVOUTPUT_H
...
//! Options
class CaseOptionsSimpleCsvOutput
{
public:
  ...
  CaseOptionsSimpleCsvOutput(Arcane::ICaseOptions* co)
    : m_case_options(co)
      , tableName(Arcane::CaseOptionBuildInfo(_configList(),
        /* name       */ "tableName", _element(),
        /* default    */ "",
        /* min-occurs */ 1,
        /* max-occurs */ 1,
        /* optional   */ false))
      , tableDir(Arcane::CaseOptionBuildInfo(_configList(),
        /* name       */ "tableDir", _element(),
        /* default    */ "",
        /* min-occurs */ 1,
        /* max-occurs */ 1,
        /* optional   */ false))
...
public:
  // Interfaces for main CaseOptions
    ...
    Arcane::String getTableName() { return tableName(); }
    Arcane::String getTableDir() { return tableDir(); }
...
#ifndef ARCANE_MODULE_AXLSTAR_SIMPLECSVOUTPUT_H
#define ARCANE_MODULE_AXLSTAR_SIMPLECSVOUTPUT_H
...
class ArcaneSimpleCsvOutputObject
  : public Arcane::BasicCaseOptionService
  , public Arcane::ISimpleTableOutput
{
public:
  ...
  {
    si->setCaseOptionsFileName("SimpleCsvOutput_arcane_std");
    si->setAxlVersion(1.0);
    si->setDefaultTagName("simple-csv-output");
    si->setAxlContent(getAxlContent());
    Arcane::ServiceAllInterfaceRegisterer<ServiceClassType>::registerToServiceInfo(si
    ,ARCANE_SERVICE_INTERFACE(Arcane::ISimpleTableOutput)
);
  }
...
public:
    ...
    , m_options(nullptr)
  {
    ...
    if (co) {
      m_options = new CaseOptionsSimpleCsvOutput(co);
    }
...
public:
  ...
  CaseOptionsSimpleCsvOutput* options() const { return m_options; }
...
#define ARCANE_REGISTER_SERVICE_SIMPLECSVOUTPUT(service_name,class_name) \
